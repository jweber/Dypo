...
namespace Dypo.Utility
{
    ...
    {
        private static readonly ConcurrentDictionary<string, Delegate> ModelMappers = new ConcurrentDictionary<string, Delegate>();
        ...
        internal static Func<IDataReader, dynamic> GetDynamicMapper(IDataReader reader, string query)
        {
            ...
            var m = new DynamicMethod(string.Format("__model_mapper_{0}", ModelMappers.Count), typeof(ExpandoObject), new[] { typeof(IDataReader) }, true);
